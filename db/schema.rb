...
ActiveRecord::Schema.define(version: 20_210_619_134_039) do
  ...
  create_table 'favorites', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[customer_id restaurant_id], name: 'index_favorites_on_customer_id_and_restaurant_id', unique: true
